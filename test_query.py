...
if __name__ == '__main__':
    ...
    k = 10
    for q in [5, 10, 15, 20, 50, 100]:
        print(q)
        for shot in [1,3,5]:
            print(shot)
            accuracy_info_shot_q = test_sgc(out_dict=out_dict, shot=shot, n_ways=n_ways, n_queries=q, k=k)
            print('Meta Test: LAST\n{}\t{:.4f}({:.4f})'.format('GVP shot_q', *accuracy_info_shot_q))
